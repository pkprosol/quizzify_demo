  ...
  const gameArray = [
    {
      ...
      sidePanel: {
        image: "https://raw.githubusercontent.com/pkprosol/quizzify_demo/master/src/quaker.jpg",
        bodyText: <p><strong>INGREDIENTS:</strong><br />
            QUINOA, YOGURT FLAVORED COATING (<span>SUGAR</span>, PALMKERNEL AND PALM OIL, WHEY PROTEIN CONCENTRATE, DRIED NONFAT YOGURT - HEAT TREATED AFTER CULTURING [CULTURED NONFAT MILK], SOY LECITHIN, NATURAL FLAVOR, ARTIFICIAL COLOR, CITRIC ACID, SALT), <span>GLUCOSE</span>, GRANOLA (WHOLE GRAIN ROLLED OATS, WHOLEGRAIN ROLLED WHEAT, <span>BROWN SUGAR</span>, SUNFLOWER OIL, DRIED UNSWEETENED COCONUT, <span>HONEY</span>, SODIUM BICARBONATE, NATURAL FLAVOR, WHEY AND WHEY PROTEIN CONCENTRATE), BROWN RICE CRISP (WHOLE GRAIN BROWN RICE FLOUR, <span>SUGAR</span>, MALTED BARLEY FLOUR, SALT), CARAMEL FLAVORED COATING (<span>GLUCOSE</span>, <span>SUGAR</span>, PALMOIL, NONFAT MILK, GLYCERIN, BUTTER (CREAM, SALT), MODIFIED CORNSTARCH, WHEY, SALT, MONO AND DIGLYCERIDES, NATURAL AND ARTIFICIAL FLAVOR, SOY LECITHIN), <span>INVERT SUGAR</span>, <span>CORN SYRUP SOLIDS</span>, ALMONDS, GLYCERIN, PEANUTS, DRIED SWEETENED CRANBERRY PIECES (<span>SUGAR</span>, DRIED CRANBERRIES, CITRIC ACID, ELDERBERRY JUICE CONCENTRATE [COLOR], SUNFLOWER OIL), RAISINS, SUNFLOWER KERNELS (SUNFLOWER SEED, SUNFLOWER OIL AND/OR COTTONSEED OIL), VEGETABLE SHORTENING (PALM KERNEL OIL, PALM OIL, SORBITAN TRISTEARATE, TBHQ [A PRESERVATIVE], CITRIC ACID), SALT, TOCOPHEROLS (PRESERVATIVE).
          </p>,
        bodyTextComplete: <p><strong>INGREDIENTS:</strong><br />
